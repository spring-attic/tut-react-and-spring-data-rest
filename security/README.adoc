...
:prev_session: https://spring.io/blog/2015/10/13/react-js-and-spring-data-rest-part-4-events
...
Feel free to https://github.com/gregturn/react-and-spring-data-rest/tree/master/security[grab the code] from this repository and follow along. This session is based on the previous session's app with extra things added.
