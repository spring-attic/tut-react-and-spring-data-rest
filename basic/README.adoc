...
IMPORTANT: The code for `client` is not shown because what you use to make REST calls isn't important. Feel free to check the source, but the point is, you can plugin Restangular or anything you like, and the concepts still apply.
