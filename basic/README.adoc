...
[[NOTE]]
====
Does this code contain both HTML _and_ JavaScript? Yes. If you noticed the file extension, this is https://facebook.github.io/js/[JSX]. There is no requirement to use it. React can be written using pure JavaScript, but the JSX syntax is quite terse.
