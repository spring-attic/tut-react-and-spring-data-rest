...
* You added the ability to create new employees.
* You updated the UI to dynamically creates buttons to use the page-based hypermedia controls.
* You added the ability to create and delete employees, and then update the UI as needed.
* You made it possible to change the page size and have the UI dynamically respond to that.
