...
[source,javascript,indent=0]
----
include::src/main/resources/static/app.js[tag=delete]
----
...
[source,javascript,indent=0]
----
include::src/main/resources/static/app.js[tag=handle-page-size-updates]
----
...
[source,javascript,indent=0]
----
include::src/main/resources/static/app.js[tag=update-page-size]
----
