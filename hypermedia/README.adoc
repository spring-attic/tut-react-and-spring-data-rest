...
To get off the ground, you can either https://github.com/gregturn/react-and-spring-data-rest/tree/master/hypermedia[grab the code] from this repository, or you can do it yourself, by hand. This project is based on the previous session with more modifications coming.
