...
= React.js and Spring Data REST: Part 3 - Events
...
That's great if you are the only one viewing the data. But what about other people? In this session you'll learn how to use Spring Data REST's built in event system and publish updates to ALL users through Spring's WebSocket support. Then you'll be able to dynamically adjust clients as the data updates.
